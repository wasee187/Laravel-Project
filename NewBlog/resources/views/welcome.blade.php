                    ...
                    <div class="post__content">
                        ...
                        <div class="post__content-info">
                            ...
                            <h2 class="post__title entry-title ">
                                <a href="{{route('post.single_view',['slug'=>$first_post->slug])}}" class="text-center">{{$first_post->title}}</a>
                            </h2>
                ...
                <article class="hentry post post-standard has-post-thumbnail sticky">
                    ...
                    <div class="post__content">
                        ...
                        <div class="post__content-info">
                            ...
                            <h2 class="post__title entry-title ">
                                <a href="{{route('post.single_view',['$slug'=>$second_post->slug])}}">{{$second_post->title}}</a>
                            </h2>
                ...
                <article class="hentry post post-standard has-post-thumbnail sticky">
                    ...
                    <div class="post__content">
                        ...
                        <div class="post__content-info">
                            ...
                            <h2 class="post__title entry-title ">
                                <a href="{{route('post.single_view',['$slug'=>$third_post->slug])}}">{{$third_post->title}}</a>
                            </h2>
                    ...
                    <div class="offers">
                        ...
                        <div class="row">
                            <div class="case-item-wrap">
                                @foreach($php->posts()->take(3)->get() as $post)
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                        <div class="case-item">
                                            ...
                                            <h6 class="case-item__title text-center"><a href="{{route('post.single_view',['$slug'=>$post->slug])}}">{{$post->title}}</a></h6>
                                        </div>
                                    </div>
